...
SYSMMU_RESOURCE_DEFINE(EXYNOS4, 2d,	2D,	2D);
SYSMMU_RESOURCE_DEFINE(EXYNOS4, tv,	TV,	TV);
SYSMMU_RESOURCE_DEFINE(EXYNOS4, 2d_acp,	G2D_ACP, 2D);
SYSMMU_RESOURCE_DEFINE(EXYNOS4, rot,	ROTATOR, ROTATOR);
SYSMMU_RESOURCE_DEFINE(EXYNOS4, fimd0,	FIMD0,	FIMD0);
SYSMMU_RESOURCE_DEFINE(EXYNOS4, fimd1,	FIMD1,	FIMD1);
SYSMMU_RESOURCE_DEFINE(EXYNOS4, flite0,	LITE0, LITE0);
SYSMMU_RESOURCE_DEFINE(EXYNOS4, flite1,	LITE1, LITE1);
SYSMMU_RESOURCE(EXYNOS4, mfc_lr) {
	DEFINE_SYSMMU_RESOURCE(EXYNOS4, MFC_R, MFC_R),
	DEFINE_SYSMMU_RESOURCE(EXYNOS4, MFC_L, MFC_L),
};
SYSMMU_RESOURCE(EXYNOS4, isp) {
	DEFINE_SYSMMU_RESOURCE(EXYNOS4, ISP, ISP),
	DEFINE_SYSMMU_RESOURCE(EXYNOS4, DRC, DRC),
	DEFINE_SYSMMU_RESOURCE(EXYNOS4, FD, FD),
	DEFINE_SYSMMU_RESOURCE(EXYNOS4, ISPCPU, MCUISP),
};
